...
def _work(process_id, model, dataset, args):
    ...
    with torch.no_grad(), cuda.device(process_id):
        ...
        for iter, pack in enumerate(data_loader):
            ...
            #print("###############orig_img_size:",orig_img_size.shape)

            #print("###############pack['img'][0]:",pack['img'][0].shape)
            ...
            rw_up = F.interpolate(rw, scale_factor=4, mode='bilinear', align_corners=False)#torch.Size([2, 1, 284, 500])
            #print("rw_up shape after interpolate:", rw_up.shape)
            rw_up = rw_up[..., 0, :orig_img_size[0], :orig_img_size[1]]##########: torch.Size([2, 281, 500]
            #print("rw_up shape after interpolate##########:", rw_up.shape)
