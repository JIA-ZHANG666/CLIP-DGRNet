...
class Transformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        #x, attn_weight = self.resblocks[self.layers-1](x)
        #attn_weights.append(attn_weight)
        #print("########attn_weightSSS:",attn_weights)
...
class CLIP(nn.Module):
    ...
    def forward_last_layer(self, image_features, text_features):
        ...
        #print("########attn_weightS222:",attn_weight)
        #x, attn_weight = self.visual.transformer.resblocks[-1](image_features)
        #x, _ = self.visual.transformer(image_features)
        #print("#####x:",x.shape)
        x = x.permute(1, 0, 2)  # LND -> NLD
